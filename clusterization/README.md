...
**Остальное*:*
- `shutil, os` - управление дирректориями
- `subprocess` - управление терминалом
- `multiprocessing` - паралельное выполнение программы (в несколько процессов)
- `functools.partial` - для удобного использования функций в map
